...
%>
	...
	<!--  <div data-options="region:'north',split:true" style="height:80px;" text-align: center> <p class="header" >后台管理系统</p> </div> -->
		<div data-options="region:'west',split:true" title="菜单区" style="width:200px;">
			<div class="easyui-accordion" data-options="fit:true,border:false">
				<div title="用户管理" style="padding:10px;" data-options="selected:true">
					<a href="#"  onclick="addTab('用户管理','backstage_BackStageServlet_userlistByPage')">用户管理</a><br>
    				<a href="#"  onclick="addTab('仓库管理','backstage_BackStageServlet_goodlistByPage')">仓库管理</a><br>
    				
				</div>
				<div title="商品管理"  style="padding:10px;">
					<a href="#"  onclick="addTab('商品详情管理','backstage_BackStageServlet_goodlistByPage')">商品管理</a><br>
				    <a href="#"  onclick="addTab('新增商品','addgood.jsp')">新增商品</a><br>
				    <a href="#"  onclick="addTab('新增商品','findgood.jsp')">搜索商品</a><br>
				</div>
		...
		<div id="tt" class="easyui-tabs" data-options="region:'center',title:'工作区',iconCls:'icon-ok'">
			<div class="easyui-tabs" data-options="fit:true,border:false,plain:true">
				<div title="首页" data-options="href:'content.jsp'" style="padding:10px">
				</div>
